...
public class SqlFailedService extends RunErrorBaseService {
    ...
    public String generateItemDesc() {
        return MessageSourceUtil.get("SQL_FAILED_ANALYSIS");
    }

    @Override
    public Conclusion generateConclusion() {
        return new Conclusion(MessageSourceUtil.get("SQL_FAILED_CONCLUSION"), MessageSourceUtil.get("SQL_FAILED_CONCLUSION_DESC"));
    }
}
