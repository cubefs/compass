...
import static com.oppo.cloud.diagnosis.constant.MonitorMetricConstant.BACK_PRESSURE_VERTICES;
...
public class BackPressureRule extends BaseRule {
    ...
    public RcJobDiagnosisAdvice advice(DiagnosisContext context) {
        ...
        data.setAdviceType(EDiagnosisRule.BackPressure);
        ...
        if (data.getBpRecord().size() != 0) {
            ...
            diagnosisRuleLineChart.setYAxisValueType(EDiagnosisReportYAxisType.Numeric.name());
