...
import static com.oppo.cloud.common.domain.flink.enums.EDiagnosisParam.FlowMax;
...
public class JobNoTraffic extends BaseRule {
    ...
    public RcJobDiagnosisAdvice advice(DiagnosisContext context) {
        ...
        builder.adviceType(EDiagnosisRule.JobNoTraffic);
        ...
        if (flowObj != null && (Integer) flowObj == 0) {
            ...
            diagnosisRuleLineChart.setYAxisValueType(EDiagnosisReportYAxisType.BytesPerSecond.name());
