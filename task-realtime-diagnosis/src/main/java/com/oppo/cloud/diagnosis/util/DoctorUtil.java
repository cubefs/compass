...
import static com.oppo.cloud.common.domain.flink.enums.EDiagnosisParam.*;
...
public class DoctorUtil {
    ...
    public Double getMemLowThreshold(DiagnosisContext context) {
        ...
        if (context.getMessages().get(MemLowThreshold) != null) {
            lowThreshold = (Double) context.getMessages().get(MemLowThreshold);
            lowThreshold = lowThreshold / 100;
        }
        return lowThreshold;
    }
    ...
    public Double getMemLowTarget(DiagnosisContext context) {
        ...
        if (context.getMessages().get(MemLowTarget) != null) {
            lowTarget = (Double) context.getMessages().get(MemLowTarget);
            lowTarget = lowTarget / 100;
        }
        return lowTarget;
    }
    ...
    public Double getMemHighThreshold(DiagnosisContext context) {
        ...
        if (context.getMessages().get(MemHighThreshold) != null) {
            highThreshold = (Double) context.getMessages().get(MemHighThreshold);
            highThreshold = highThreshold / 100;
        }
        return highThreshold;
    }
    ...
    public Double getMemHighTarget(DiagnosisContext context) {
        ...
        if (context.getMessages().get(MemHighTarget) != null) {
            highTarget = (Double) context.getMessages().get(MemHighTarget);
            highTarget = highTarget / 100;
        }
        return highTarget;
    }
