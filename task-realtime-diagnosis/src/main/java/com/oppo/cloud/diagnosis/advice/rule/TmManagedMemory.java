...
import static com.oppo.cloud.diagnosis.constant.MonitorMetricConstant.TM_MANAGE_MEM_TOTAL;
import static com.oppo.cloud.diagnosis.constant.MonitorMetricConstant.TM_MANAGE_MEM_USAGE;
...
public class TmManagedMemory extends BaseRule {
    ...
    public RcJobDiagnosisAdvice advice(DiagnosisContext context) {
        ...
        data.setAdviceType(EDiagnosisRule.TmManagedMemory);
