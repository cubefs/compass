...
public class JobDelayHigh extends BaseRule {
    ...
    public RcJobDiagnosisAdvice advice(DiagnosisContext context) {
        ...
        builder.adviceType(EDiagnosisRule.JobDelay);
        ...
        log.info("{} {}-{} 作业最近延迟 {} second", rcJobDiagnosis.getJobName(), context.getStart(),
        ...
        if ((isDelay || (offsetGrow10minutes && delayLittleHigh))) {
            ...
            diagnosisRuleLineChart.setYAxisValueType(EDiagnosisReportYAxisType.Second.name());
    ...
    private boolean offsetGrow10minutes(DiagnosisContext context) {
        List<MetricResult.DataResult> offsetDeltaMetrics = realtimeDiagnosisMetricsServiceImpl
