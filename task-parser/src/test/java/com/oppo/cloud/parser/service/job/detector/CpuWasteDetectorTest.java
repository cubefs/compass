...
import com.oppo.cloud.parser.service.job.detector.spark.CpuWasteDetector;
import org.junit.jupiter.api.Test;
import org.springframework.boot.test.context.SpringBootTest;

class CpuWasteDetectorTest {

    @Test
    void detect() throws Exception {
        DetectorParam param = ParamUtil.getDetectorParam();
        CpuWasteDetector detector = new CpuWasteDetector(param);
