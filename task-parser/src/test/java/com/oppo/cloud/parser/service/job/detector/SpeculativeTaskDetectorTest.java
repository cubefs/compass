...
import com.oppo.cloud.parser.service.job.detector.spark.SpeculativeTaskDetector;
import org.junit.jupiter.api.Test;
import org.springframework.boot.test.context.SpringBootTest;

class SpeculativeTaskDetectorTest {

    @Test
    void detect() throws Exception {
        DetectorParam param = ParamUtil.getDetectorParam();
        SpeculativeTaskDetector detector = new SpeculativeTaskDetector(param);
