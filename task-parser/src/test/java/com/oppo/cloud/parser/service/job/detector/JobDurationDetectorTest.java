...
import com.oppo.cloud.parser.service.job.detector.spark.JobDurationDetector;
import org.junit.jupiter.api.Test;

class JobDurationDetectorTest {

    @Test
    void detect() throws Exception {
        DetectorParam param = ParamUtil.getDetectorParam();
        JobDurationDetector detector = new JobDurationDetector(param);
