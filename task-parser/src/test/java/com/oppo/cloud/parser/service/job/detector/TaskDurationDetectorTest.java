...
import com.oppo.cloud.parser.service.job.detector.spark.TaskDurationDetector;
import org.junit.jupiter.api.Test;
import org.springframework.boot.test.context.SpringBootTest;

class TaskDurationDetectorTest {

    @Test
    void detect() throws Exception {
        DetectorParam param = ParamUtil.getDetectorParam();
        TaskDurationDetector detector = new TaskDurationDetector(param);
