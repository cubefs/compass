...
import com.oppo.cloud.parser.service.job.detector.spark.StageDurationDetector;
import org.junit.jupiter.api.Test;
import org.springframework.boot.test.context.SpringBootTest;

@SpringBootTest
class StageDurationDetectorTest {

    @Test
    void detect() throws Exception {
        DetectorParam param = ParamUtil.getDetectorParam();
        StageDurationDetector detector = new StageDurationDetector(param);
