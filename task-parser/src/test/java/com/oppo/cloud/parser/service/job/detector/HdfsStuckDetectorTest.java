...
import com.oppo.cloud.parser.service.job.detector.spark.HdfsStuckDetector;
import org.junit.jupiter.api.Test;
import org.springframework.boot.test.context.SpringBootTest;

@SpringBootTest
class HdfsStuckDetectorTest {

    @Test
    void detect() throws Exception {
        DetectorParam param = ParamUtil.getDetectorParam();
        HdfsStuckDetector detector = new HdfsStuckDetector(param);
